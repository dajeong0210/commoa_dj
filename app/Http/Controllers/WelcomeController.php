...
class WelcomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('welcome')->with('products', $products)->with('products1', $products1)->with('products2', $products2)->with('products3', $products3)->with('shops', $shops)->with('banners', $banners)->with('recommends', $recommends);
    }
}
