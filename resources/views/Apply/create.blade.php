            ...
            {{ csrf_field() }}
                ...
                <div class="contact-group group">
                    ...
                    <div class="form-group half-layout">
                        ...
                        <input type="phone" name="contact_mobile" class="input contact_mobile" placeholder="'-'를 제외한 숫자만 입력해주세요." value="{{ old('contact_mobile') }}"/>
                    </div>
                    <div class="form-group half-layout form-group{{ $errors->has('contact_phone') ? ' has-error' : '' }}">
                        <label for="contact_phone">전화</label>
                        <input type="phone" name="contact_phone" class="input contact_phone required" placeholder="'-'를 제외한 숫자만 입력해주세요." value="{{ old('contact_phone') }}"/>
